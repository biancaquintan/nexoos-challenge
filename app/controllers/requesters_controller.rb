class RequestersController < ApplicationController
  ...
  def new
    ...
    @requester.addresses.build
    @requester.telephones.build
  end
  ...
  private
    ...
    def requester_params
      params.require(:requester).permit(:razao_social, :cnpj, :addresses_attributes => [
        :id, :street, :number, :city, :state, :cep, :_destroy], :telephones_attributes => [
          :id, :ddd, :phone, :_destroy])
    end
end
