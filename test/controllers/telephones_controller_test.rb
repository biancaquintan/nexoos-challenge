...
class TelephonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telephone" do
    assert_difference('Telephone.count') do
      post telephones_url, params: { telephone: { ddd: @telephone.ddd, phone: @telephone.phone, requester_id: @telephone.requester_id } }
    end
  ...
  test "should update telephone" do
    patch telephone_url(@telephone), params: { telephone: { ddd: @telephone.ddd, phone: @telephone.phone, requester_id: @telephone.requester_id } }
