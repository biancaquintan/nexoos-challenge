...
class CreditRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_request" do
    assert_difference('CreditRequest.count') do
      post credit_requests_url, params: { credit_request: { periods: @credit_request.periods, requester_id: @credit_request.requester_id, taxa: @credit_request.taxa, value: @credit_request.value } }
    end
  ...
  test "should update credit_request" do
    patch credit_request_url(@credit_request), params: { credit_request: { periods: @credit_request.periods, requester_id: @credit_request.requester_id, taxa: @credit_request.taxa, value: @credit_request.value } }
