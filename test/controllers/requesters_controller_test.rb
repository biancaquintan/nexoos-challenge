...
class RequestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requester" do
    assert_difference('Requester.count') do
      post requesters_url, params: { requester: { cnpj: @requester.cnpj, razao_social: @requester.razao_social } }
    end
  ...
  test "should update requester" do
    patch requester_url(@requester), params: { requester: { cnpj: @requester.cnpj, razao_social: @requester.razao_social } }
